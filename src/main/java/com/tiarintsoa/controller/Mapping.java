...
import com.tiarintsoa.authentication.Authenticator;
...
import com.tiarintsoa.exception.MissingErrorUrlException;
import com.tiarintsoa.exception.UnauthorisedException;
import com.tiarintsoa.exception.VerbNotFoundException;
import com.tiarintsoa.reflection.Reflect;
import com.tiarintsoa.session.WinterSession;
import com.tiarintsoa.validation.FieldErrors;
import com.tiarintsoa.validation.ParameterValidator;
...
public class Mapping {
    ...
    public boolean isRestAPI(RequestVerb verb) {
        return methods.get(verb).isAnnotationPresent(RestEndPoint.class) || controller.isAnnotationPresent(
